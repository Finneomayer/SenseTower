...
Roughly equal to number of cores used")]
        ...
        */
        ...
        private string GetAssetPathForFile(string file, bool suppressNonExistentWarning = false)
        {
            ...
            //return IsAndroidStandalone ? file : Path.Combine(Application.streamingAssetsPath, file); //original code
            return IsAndroidStandalone ? file : "SenseTower_Data/StreamingAssets/Oculus/"; //custom script (loading OvrAvatar2Assets.zip)
        }
