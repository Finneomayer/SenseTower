...
#pragma warning restore CS0414
    ...
    public event Action<bool> AvatarStubVisibilityChanged;
    ...
    private IEnumerator VisibleCoroutine()
    {
        ...
        TooggleVisibleDefaultAvatar(true);
    ...
    public void CreateDefaultAvatar()
    {
        ...
        _visibleCoroutine = StartCoroutine(VisibleCoroutine());
        //TooggleVisibleDefaultAvatar(true);
    }

    public void TooggleVisibleDefaultAvatar(bool isVisible)
    {
        Transform defaultAvatarTransform = gameObject.transform.Find("AllLOD");
        if (defaultAvatarTransform != null)
        {
            defaultAvatarTransform.gameObject.SetActive(isVisible);
        }

        AvatarStubVisibilityChanged?.Invoke(isVisible);
    }
