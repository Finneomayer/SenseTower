...
namespace CSharpCompiler
{
    public class ScriptBundleLoader
    {
        ...
        public ScriptBundle LoadScriptFromSource(string source)
        {
            var bundle = new ScriptBundle(this, source);
            allFilesBundle.Add(bundle);
            return bundle;
        }
        ...
        public class ScriptBundle
        {
            ...
            public ScriptBundle(ScriptBundleLoader manager, string scriptSource)
            {
                this.manager = manager;
                ...
                manager.logWriter.WriteLine("loading script source ");
                CompileFromString(scriptSource);
                CreateNewInstances();
            }

            void CompileFromString(string scriptSource)
            {
                ...
                var result = compiler.CompileAssemblyFromSource(options, scriptSource);
