...
namespace Assets.Scripts.Audio
{
    ...
    public sealed class MicrophoneRecorder : MonoBehaviour
    {
        ...
        [SerializeField]
        private float _micCaptureTimeout = 500f;

        public AudioSource AudioSource => _audioSource;
        public int MicFrequency => _micFrequency;
        public bool IsMicSelected => _selectedDevice?.Length > 0;
        ...
        public event Action<AudioSourceRecordedFrame> AudioFrameRecorded;
        ...
        {
            AudioFrameRecorded?.Invoke(new AudioSourceRecordedFrame(data, channels, _micFrequency));
        }
        ...
        private void GetMicCaps()
        {
            ...
            {
                Debug.Log("MicrophoneRecorder. GetMicCaps warning - min and max frequencies are 0");
                _minFreq = 48000;
                _maxFreq = 48000;
            }
        ...
        private void StartMicrophone_Internal()
        {
            ...
            {
                Debug.Log("Timeout initializing microphone " + _selectedDevice);
                return;
            }
