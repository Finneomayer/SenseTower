...
using SC.SenseTower.Galleries.Dto;
...
using SC.SenseTower.Galleries.Extensions;
...
services.AddDatabaseContext<GalleriesDbContext>();

services.AddAutoMapper(new[]
{
    typeof(MappingProfile),
    typeof(SC.SenseTower.Galleries.Cqrs.MappingProfile),
    typeof(SC.SenseTower.Galleries.RabbitMQ.MappingProfile)
});
...
{
    o.SwaggerDoc("v1", new OpenApiInfo { Title = "Galleries API", Version = "v1" });
...
app.UseSwaggerUI(o =>
{
    o.SwaggerEndpoint("swagger/v1/swagger.json", "Galleries API v1");
