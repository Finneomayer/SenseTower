...
using SC.SenseTower.Cinemas.Dto;
using SC.SenseTower.Cinemas.Extensions;
...
services.AddDatabaseContext<CinemasDbContext>();

services.AddAutoMapper(new[]
{
    typeof(MappingProfile),
    typeof(SC.SenseTower.Cinemas.Cqrs.MappingProfile),
    typeof(SC.SenseTower.Cinemas.RabbitMQ.MappingProfile)
});
...
{
    o.SwaggerDoc("v1", new OpenApiInfo { Title = "Cinemas API", Version = "v1" });
...
app.UseSwaggerUI(o =>
{
    o.SwaggerEndpoint("swagger/v1/swagger.json", "Cinemas API v1");
