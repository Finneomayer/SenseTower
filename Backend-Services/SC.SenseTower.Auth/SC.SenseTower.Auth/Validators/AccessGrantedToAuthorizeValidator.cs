...
{
    public class AccessGrantedToAuthorizeValidator : ICustomAuthorizeRequestValidator
    {
        private readonly UserManager<ApplicationUser> userManager;

        public AccessGrantedToAuthorizeValidator(UserManager<ApplicationUser> userManager)
        {
